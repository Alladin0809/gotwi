...
import (
	...
	"github.com/Alladin0809/gotwi/tweet/filteredstream/types"
)

const (
	listRulesEndpoint           = "https://api.x.com/2/tweets/search/stream/rules"
	createOrDeleteRulesEndpoint = "https://api.x.com/2/tweets/search/stream/rules"
	searchStreamEndpoint        = "https://api.x.com/2/tweets/search/stream"
)
