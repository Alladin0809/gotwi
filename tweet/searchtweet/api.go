...
import (
	...
	"github.com/Alladin0809/gotwi/tweet/searchtweet/types"
)

const (
	listRecentEndpoint = "https://api.x.com/2/tweets/search/recent"
	listAllEndpoint    = "https://api.x.com/2/tweets/search/all"
)
