...
const (
	listJobsEndpoint  = "https://api.x.com/2/compliance/jobs"
	GetJobEndpoint    = "https://api.x.com/2/compliance/jobs/:id"
	createJobEndpoint = "https://api.x.com/2/compliance/jobs"
)
